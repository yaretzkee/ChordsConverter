...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/logos/app_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/actions/folder_open.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionOpen.setIcon(icon1)
        self.actionSave = QAction(MainWindow)
        self.actionSave.setObjectName(u"actionSave")
        icon2 = QIcon()
        icon2.addFile(u":/actions/media-floppy.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionSave.setIcon(icon2)
        self.actionAbout = QAction(MainWindow)
        self.actionAbout.setObjectName(u"actionAbout")
        self.actionAbout.setEnabled(False)
        icon3 = QIcon()
        icon3.addFile(u":/actions/help.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionAbout.setIcon(icon3)
        self.actionUltimate_Guitar = QAction(MainWindow)
        self.actionUltimate_Guitar.setObjectName(u"actionUltimate_Guitar")
        icon4 = QIcon()
        icon4.addFile(u":/examples/application-ug.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u":/examples/application-chopro.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/examples/application-x-tex.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/examples/application-hk.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionHK.setIcon(icon7)
        self.actionConvert = QAction(MainWindow)
        self.actionConvert.setObjectName(u"actionConvert")
        icon8 = QIcon()
        icon8.addFile(u":/actions/media-playback-start.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon8.addFile(u"C:/Users/yara/.designer/img/icon-convert.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.actionConvert.setIcon(icon8)
        self.action_Quit = QAction(MainWindow)
        self.action_Quit.setObjectName(u"action_Quit")
        icon9 = QIcon()
        icon9.addFile(u":/actions/icon-quit.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/examples/application-wywrota.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionWywrota.setIcon(icon10)
        self.actionTheme_Light = QAction(MainWindow)
        self.actionTheme_Light.setObjectName(u"actionTheme_Light")
        self.actionTheme_Light.setCheckable(True)
        self.actionTheme_Dark = QAction(MainWindow)
        self.actionTheme_Dark.setObjectName(u"actionTheme_Dark")
        self.actionTheme_Dark.setCheckable(True)
        self.actionTheme_OS = QAction(MainWindow)
        self.actionTheme_OS.setObjectName(u"actionTheme_OS")
        self.actionTheme_OS.setCheckable(True)
        self.actionTheme_OS.setChecked(True)
        ...
        self.splitter_comboboxes = QSplitter(self.centralwidget)
        self.splitter_comboboxes.setObjectName(u"splitter_comboboxes")
        self.splitter_comboboxes.setOrientation(Qt.Horizontal)
        self.cbx_input_format = QComboBox(self.splitter_comboboxes)
        icon11 = QIcon()
        icon11.addFile(u":/examples/application-ug.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.cbx_input_format.addItem(icon11, "")
        icon12 = QIcon()
        icon12.addFile(u":/examples/application-chopro.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.cbx_input_format.addItem(icon12, "")
        icon13 = QIcon()
        icon13.addFile(u":/examples/application-x-tex.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.cbx_input_format.addItem(icon13, "")
        self.cbx_input_format.addItem(icon13, "")
        icon14 = QIcon()
        icon14.addFile(u":/examples/application-hk.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.cbx_input_format.addItem(icon14, "")
        icon15 = QIcon()
        icon15.addFile(u":/examples/application-wywrota.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        self.splitter_comboboxes.addWidget(self.cbx_input_format)
        self.cbx_output_format = QComboBox(self.splitter_comboboxes)
        ...
        self.splitter_comboboxes.addWidget(self.cbx_output_format)

        self.gridLayout_3.addWidget(self.splitter_comboboxes, 1, 0, 1, 3)

        self.splitter = QSplitter(self.centralwidget)
        self.splitter.setObjectName(u"splitter")
        self.splitter.setOrientation(Qt.Horizontal)
        self.text_in = QPlainTextEdit(self.splitter)
        ...
        self.splitter.addWidget(self.text_in)
        self.text_out = QPlainTextEdit(self.splitter)
        ...
        self.splitter.addWidget(self.text_out)

        self.gridLayout_3.addWidget(self.splitter, 5, 0, 1, 3)

        self.splitter_row2 = QSplitter(self.centralwidget)
        self.splitter_row2.setObjectName(u"splitter_row2")
        self.splitter_row2.setOrientation(Qt.Horizontal)
        self.le_URL = QLineEdit(self.splitter_row2)
        self.le_URL.setObjectName(u"le_URL")
        self.le_URL.setClearButtonEnabled(True)
        self.splitter_row2.addWidget(self.le_URL)
        self.btn_chords_above = QPushButton(self.splitter_row2)
        ...
        self.btn_chords_above.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        self.btn_chords_above.setAutoFillBackground(False)
        icon16 = QIcon()
        icon16.addFile(u":/states/switch_off.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon16.addFile(u":/states/switch_on.png", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        self.splitter_row2.addWidget(self.btn_chords_above)

        self.gridLayout_3.addWidget(self.splitter_row2, 2, 0, 1, 3)
        ...
        self.menuToolbars = QMenu(self.menuSettings)
        ...
        MainWindow.addToolBar(Qt.ToolBarArea.TopToolBarArea, self.toolBar_actions)
        ...
        MainWindow.addToolBar(Qt.ToolBarArea.TopToolBarArea, self.toolBar_examples)
        ...
        self.menuSettings.addAction(self.menuToolbars.menuAction())
        ...
        self.menuTheme.addAction(self.actionTheme_Light)
        self.menuTheme.addAction(self.actionTheme_Dark)
        self.menuTheme.addAction(self.actionTheme_OS)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionTheme_Light.setText(QCoreApplication.translate("MainWindow", u"Light", None))
        self.actionTheme_Dark.setText(QCoreApplication.translate("MainWindow", u"Dark", None))
        self.actionTheme_OS.setText(QCoreApplication.translate("MainWindow", u"OS Preferred", None))
